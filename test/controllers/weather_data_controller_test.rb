...
class WeatherDataControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weather_datum" do
    assert_difference('WeatherDatum.count') do
      post weather_data_url, params: { weather_datum: { temperature_c: @weather_datum.temperature_c, temperature_f: @weather_datum.temperature_f, zipcode: @weather_datum.zipcode } }
    end
  ...
  test "should update weather_datum" do
    patch weather_datum_url(@weather_datum), params: { weather_datum: { temperature_c: @weather_datum.temperature_c, temperature_f: @weather_datum.temperature_f, zipcode: @weather_datum.zipcode } }
